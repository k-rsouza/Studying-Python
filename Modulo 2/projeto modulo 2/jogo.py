...
class Jogo:
    ...
    def __init__(self) -> None:
        self.heroi = Heroi(nome="Hero", vida=250, nivel=10, habilidade="Raio Congelante")
        self.inimigo = Inimigo(nome="Morcego", vida=120, nivel=6, tipo="Voador")

    def iniciar_batalha(self):
        '''Faz a gestao da batalha em turnos'''
